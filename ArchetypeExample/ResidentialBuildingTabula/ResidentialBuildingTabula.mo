...
model ResidentialBuildingTabula
  "This is the simulation model of ResidentialBuildingTabula with traceable ID 3"
...
AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    zoneParam = {
      ResidentialBuildingTabula_DataBase.ResidentialBuildingTabula_SingleDwelling()
      },
  heatAHU = false,
  coolAHU = false,
  dehuAHU = false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://ArchetypeExample/ResidentialBuildingTabula/InternalGains_ResidentialBuildingTabula.txt"),
    columns=2:4)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://ArchetypeExample/ResidentialBuildingTabula/AHU_ResidentialBuildingTabula.txt"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://ArchetypeExample/ResidentialBuildingTabula/TsetHeat_ResidentialBuildingTabula.txt"),
    columns=2:2)
    ...
    Modelica.Blocks.Sources.CombiTimeTable tableTSetCool(
      ...
      extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://ArchetypeExample/ResidentialBuildingTabula/TsetCool_ResidentialBuildingTabula.txt"),
      columns=2:2)
...
equation
  ...
  annotation (experiment(
      ...
      __Dymola_Commands(file=
        "Resources/Scripts/Dymola/ResidentialBuildingTabula/ResidentialBuildingTabula.mos"
      "Simulate and Plot"),
    __Dymola_selections={
